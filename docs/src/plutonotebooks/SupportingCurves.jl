...
begin
	...
	#Pkg.activate(".");
	#Pkg.instantiate();
	using DataFrames, LinearAlgebra, CSV, Statistics,  PDBTools, EasyFit, ComplexMixtures, LaTeXStrings, PlutoUI, Unitful, Printf, PrettyTables, Plots;
	using Images;
	TableOfContents();
end
...
begin
	figs1 = Images.load("Figures/SI_mddfs_cl_dca.png")
...
begin
	figs2 = Images.load("Figures/SI_mddfs_bf4_no3.png")
...
begin
	figs4 = Images.load("Figures/SI_mddfs_cl_dca-cat.png")
...
begin
	figs3 = Images.load("Figures/SI_mddfs_bf4_no3-cat.png")
...
begin
	img_d1 = Images.load("Figures/density2D_diff_DCA.png")
...
begin
	img_d2 = Images.load("Figures/density2D_diff_Cl.png")
	#img_d2
...
begin
	img_d3 = Images.load("Figures/density2D_diff_BF4.png")
	#img_d2
...
begin
	img_d4 = Images.load("Figures/density2D_diff_NO3.png")
	#img_d2
